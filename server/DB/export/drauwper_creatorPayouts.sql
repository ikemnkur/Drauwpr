...
--
-- Table structure for table `creatorPayouts`
--

DROP TABLE IF EXISTS `creatorPayouts`;
...
--
-- Dumping data for table `creatorPayouts`
--

LOCK TABLES `creatorPayouts` WRITE;
/*!40000 ALTER TABLE `creatorPayouts` DISABLE KEYS */;
INSERT INTO `creatorPayouts` VALUES ('payout-001','creator-3',14700,14.70,'stripe','tr_mock_001',NULL,NULL,NULL,NULL,'completed','2026-04-01 02:34:15',NULL,'2026-04-01 03:34:15');
/*!40000 ALTER TABLE `creatorPayouts` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-06-12 10:09:15
