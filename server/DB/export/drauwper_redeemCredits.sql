...
--
-- Table structure for table `redeemCredits`
--

DROP TABLE IF EXISTS `redeemCredits`;
...
--
-- Dumping data for table `redeemCredits`
--

LOCK TABLES `redeemCredits` WRITE;
/*!40000 ALTER TABLE `redeemCredits` DISABLE KEYS */;
/*!40000 ALTER TABLE `redeemCredits` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-06-12 10:09:51
