...
--
-- Table structure for table `dropFavorites`
--

DROP TABLE IF EXISTS `dropFavorites`;
...
--
-- Dumping data for table `dropFavorites`
--

LOCK TABLES `dropFavorites` WRITE;
/*!40000 ALTER TABLE `dropFavorites` DISABLE KEYS */;
INSERT INTO `dropFavorites` VALUES (1,'drop-1','c1',1,0,'2026-04-01 03:34:15'),(2,'drop-1','c3',1,1,'2026-04-01 03:34:15'),(3,'drop-2','c6',1,0,'2026-04-01 03:34:15'),(4,'drop-4','c4',1,1,'2026-04-01 03:34:15'),(5,'drop-4','u1',1,0,'2026-04-01 03:34:15');
/*!40000 ALTER TABLE `dropFavorites` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-06-12 10:09:25
